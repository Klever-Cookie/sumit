...
<!--style: interview.less -->

<div class="breadcrum">
    <div class="container">
        <a href="/">Our Products</a><span> > Interview IT</span>            
    </div>
</div>

<section id="interview-transcription">
    <div class="container">
        <div class="row-transcription">
            <div class="col-transcription order-2">
                <h2>Full Transcription First</h2>
                <p>Upload your file, and it will be transcribed automatically within a few minutes.</p>
                <button id="myBtn" class="try">Try It</button>
            </div>

            <div class="col-transcription order-1">
                <img class="img-transc" src="<?php echo get_template_directory_uri(); ?>/img/Interview-IT-1.gif">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row-sequences">
            <div class="col-sequences order-1">
                <img class="img-transc" src="<?php echo get_template_directory_uri(); ?>/img/Interview-IT-2.gif">
            </div>

            <div class="col-sequences order-2">
                <h2>Mark The <mark>Good Part</mark></h2>
                <p>Select the citations you wish to work with, and sort them by categories.</p>
    ...
    <div class="container">
        <div class="row-script">
            <div class="col-script order-2">
                <h2>Write Your Perfect Piece</h2>
                <p>Create an article in the software, using the sorted content.</p>
    ...
    <div class="container">
        <div class="row-work">
            ...
            <div class="col-work order-2">
                ...
                <p>Lastly, choose titles and other highlighted sentences to finish with style.</p>
...
<!-- The Modal -->
<div id="myModal" class="modal-interview">
    <!-- Modal content -->
                ...
                <div class="col-contact form-contact">
                    ...
                    <form action="/action_page.php">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" id="lname" name="lastname" placeholder="User@mail.com">
                        </div>

                        <div class="form-field">
                            <label for="phone">Phone number</label>
                            <input type="number" id="phone" name="phone" placeholder="051-234-5678">
                        </div>

                        <label for="subject">Your message</label>
                        <textarea id="subject" name="subject" placeholder="Dear Sumit..." style="height:200px"></textarea>

                        <input class="talk" type="submit" value="Send Message">
                    </form>
					-->
                </div>
